...
const TEXT = {
  ...
  payroll_receipt_confirmed: { zh: '已确认收到工资，谢谢。', en: 'Payroll receipt confirmed. Thank you.', vi: 'Đã xác nhận nhận lương. Cảm ơn.' },
...
const RU_TEXT = {
  ...
  payroll_receipt_confirmed: 'Получение зарплаты подтверждено. Спасибо.',
